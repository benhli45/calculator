...
txtDisplay = Entry(top_frame, font = ('arial', 18), width = 24, justify = RIGHT) 
...
#---------------------------------------------Row 2 Buttons----------------------------------------------------
btnPercent = Button(main_calc, width = 5, font = ('arial', 18), bd = 2, text = '%').grid(row = 2, column = 0, pady = 1)
...
btnDec = Button(main_calc, width = 5, font = ('arial', 18), bd = 2, text = '.', command = lambda: added_value.numberEnter('.')).grid(row = 7, column = 2, pady = 1)
